...
"""
Copy financial terms from investopedia:

# Javascript:
const terms = Array.from(document.querySelectorAll('a[class^="hellp"]'))
...
financial_terms = [
    ...
    "Asset",
    "Asset Management",
    "Asset Turnover Ratio: Definition, Calculation & Industry Comparison",
